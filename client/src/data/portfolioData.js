...
export const skillsData = [
  // ── Technical Skills ──────────────────────────────────────────
  { name: "HTML5",                  category: "technical", level: 90, icon: "🌐" },
  { name: "CSS3",                   category: "technical", level: 85, icon: "🎨" },
  { name: "JavaScript (ES6+)",      category: "technical", level: 70, icon: "🟨" },
  { name: "Bootstrap",              category: "technical", level: 65, icon: "🅱️" },
  { name: "Tailwind CSS",           category: "technical", level: 65, icon: "💨" },
  { name: "PHP",                    category: "technical", level: 68, icon: "🐘" },
  { name: "MySQL",                  category: "technical", level: 82, icon: "🗄️" },
  { name: "React.js",               category: "technical", level: 85, icon: "⚛️" },
  { name: "Node.js",                category: "technical", level: 80, icon: "🟢" },
  { name: "Express.js",             category: "technical", level: 70, icon: "🚂" },
  { name: "REST APIs",              category: "technical", level: 68, icon: "🔗" },
  { name: "Git & GitHub",           category: "technical", level: 65, icon: "📦" },
  { name: "Responsive Web Design",  category: "technical", level: 70, icon: "📱" },
  { name: "Database Design",        category: "technical", level: 80, icon: "🏗️" },
  { name: "OOP",                    category: "technical", level: 63, icon: "🔷" },
  // ── Soft Skills ───────────────────────────────────────────────
